...
[![CI](https://github.com/chubbyts/chubbyts-framework/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/chubbyts/chubbyts-framework/actions/workflows/ci.yml)
...
npm i \
  ...
  @chubbyts/chubbyts-framework@^3.2.1
```
